...
class ThrowShieldBallSkill extends Skill {
    ...
    public function getDescription(): string{
        ...
        return
sprintf('§b発動時:§f 視線の先にシールドボールを射出する。ボールが地面につくと、§eパワー§fが充電される。§eパワー§fが §c100%%%%§f になると、効果が発動される。
§b効果:§f %1$s につき §c1%%%%§f の§eパワー§fを消費して、シールドを展開する。シールドの大きさは§eパワー§fによって変わる。§f
シールド内に敵が侵入した場合、§eパワー§fを少し消費(§dアタッカー§fの場合は消費量増、§dクリーパー§fの場合は消費量激増)して、敵をはじいてシールド内から追い出す。

はじいた敵が§dアタッカー§fの場合は、はじく力が弱くなる。
